...
The first two of these, which we call ``implied infallibility'' and ``intercomparison,'' respectively, should be less common approaches than they are.  The last one of these, preferred to the first two by the CFD community generally \cite{Wesseling}, is called ``verification.''
