...
\begin{frame}{conclusion: general principles}

\begin{itemize}
\item \alert{learn a version-control system} (\texttt{git})
\item \alert{modularize your codes}
\item \alert{test the parts, and make testing repeatable} (\texttt{make test})
\item \alert{if you are stuck, write documentation for what you have}
\end{itemize}
\end{frame}
...
\end{center}
\alert{does not know what you \emph{intend}}, i.e.~your physical modelling goal
   \begin{itemize}
   \item[$\circ$] it does ``know'' your discrete equations, the program you wrote
   \end{itemize}

\bigskip
\item you \emph{can} aspire for your computer to ``know'' your continuum model, the one that you write as equations with derivatives
   \begin{itemize}
