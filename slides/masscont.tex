...
\begin{itemize}
\item let $a$ be the climatic (surface) mass balance function;  $a>0$ corresponds to accumulation
\item $s$ be the basal melt rate function (basal mass balance);  $s>0$ is basal melting
