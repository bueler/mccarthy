...
\begin{itemize}
\item \alert{please ask questions at any time! interruptions are a positive good}
\end{itemize}
...
\vspace{-3mm}
\begin{itemize}
\item two spatial dimensions (planar), along a flow line
    \begin{itemize}
    \item[$\circ$] $x$ horizontal, $z$ vertical
    \end{itemize}
\item $b(x)$: bed elevation (m) \comm{fixed in time!}
...
\item how would you prove the SKE? \comm{one answer: extra slides at end}
\end{itemize}
\end{frame}
...
\bigskip
\begin{center}
\includegraphics[width=0.9\textwidth]{giscross}
\end{center}
